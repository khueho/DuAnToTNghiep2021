...
@Autowired CinemaService cinemaservice;
	...
	@GetMapping("/today")
	public List<Show> getShowByToday() throws ParseException{
		return showservice.getShowByToday();
	}
	
	@PostMapping("/showtimes")
	public List<Show> getFilm(@RequestBody ShowtimesRequest showtimes) throws ParseException{
		return showservice.getFilm(showtimes);
	}
