...
import poly.cinema.dto.CreateOrderFoodRequest;
...
public class OrderRestController {
	...
	public List<Ticket> findTicketByOrderId(@PathVariable("orderid")String orderid) {
		return orderService.findTicketByOrderId(orderid);
	}
	...
	@PostMapping("/createOrderFood")
	public UrlRequest createOrderFood(@RequestBody CreateOrderFoodRequest data) throws UnsupportedEncodingException{
		return orderService.createOrderFood(data);
	}
